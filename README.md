...
Sales_Analysis_Page:
  ...
  -  Sales analysis by pizza category (Clustered bar charts)
  -  Sales analysis by pizza size (Treemap)
  -  Sales trend analysis per month (Line chart)
  -  Orders made by category (Pie Chart)
